  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
	...
	<div id="wrapper">
      ...
      <ul class="sidebar navbar-nav side">
        ...
        <li class="nav-item">
        <button type="button" class="btn tombol" id="desa"><div><img src="<?php echo base_url('assets/img/map.png')?>" width="30" height="30" class="img-responsive"></div>Peta Desa</button>
        </li>
   ...
   <option value="Kalimantan Selatan">Kalimantan selatan</option>
	...
	<option value="Kalimantan Barat">Kalimantan Barat</option>
	  ...
	  <?php } ?>
	  	  ...
	  	  <table id="table-BangkaBelitung" class="table " style="display:none;">
	  <tr>
	  <th>Nama Desa</th>
	  <th>Kategori</th>
	  <th>Daerah</th>
