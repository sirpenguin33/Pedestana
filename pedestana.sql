...
(7, 'Desa Suka suka', 'SMA', 'Belum', 0, 0),
(8, 'Desa manaaja', 'Sumatera Barat', 'Belum', 0, 0);
...
(17, '232311111111111111111111111111111111111111111111111111111111', 12, 8, 'Verified', 6),
(18, '111111111111111111111111111111111111111111111111111111111111', 12, 0, 'Waiting', 7);
...
--
ALTER TABLE `bnpb`
  MODIFY `ID_bnpb` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `fasilitator`
  MODIFY `ID_fasilitator` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
